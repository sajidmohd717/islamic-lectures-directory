    ...
    sectionList: [
      {
        ...
        thumbnailImage: require("./images/heart-softeners/whyme.jpg"),
      ...
      },
      {
        ...
        speaker: "Omar Suleiman",
        episodes: "32 Episodes",
        thumbnailImage: require("./images/heart-softeners/angels1.jpg"),
    ...
    sectionList: [
      {
        ...
        thumbnailImage: require("./images/general-quran-tafsir/yasirqadhi-quran.jpg"),
      ...
      },
      {
        ...
        thumbnailImage: require("./images/general-quran-tafsir/parables-quran.jpg"),
      ...
      },
      {
        ...
        thumbnailImage: require("./images/general-quran-tafsir/wisdoms_quran.jpg"),
    ...
    sectionList: [
      {
        ...
        thumbnailImage: require("./images/seerah/seerah-yasir.jpg"),
    ...
    sectionList: [
      {
        ...
        thumbnailImage: require("./images/sahaba/lives-sahaba.jpg"),
    ...
    sectionList: [
      {
        ...
        thumbnailImage: require("./images/arabic/medina-arabic.jpg"),
    ...
    sectionList: [
      {
        ...
        thumbnailImage: require("./images/manners-character/cultivate-character.jpg"),
